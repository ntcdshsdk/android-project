...
JNIEXPORT jint JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(
...
JNIEXPORT jint JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(JNIEnv* env, jclass cls, jstring library, jstring function, jobject array)
{
    int status = -1;
    ...
    if (library_handle) {
        ...
        if (SDL_main) {
             ...
             */
            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain()000");
            ...
            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain()111");
            /* Run the application. */
            status = SDL_main(argc, argv);
            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain()222");
...
ANativeWindow* Android_JNI_GetNativeWindow(void)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_GetNativeWindow");
...
void Android_JNI_SetActivityTitle(const char *title)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_SetActivityTitle");
...
int Android_JNI_GetDisplayDPI(float *ddpi, float *xdpi, float *ydpi)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_GetDisplayDPI");
...
static int Internal_Android_JNI_FileOpen(SDL_RWops* ctx)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Internal_Android_JNI_FileOpen");
...
char* Android_JNI_GetClipboardText(void)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_GetClipboardText");
...
{
    JNIEnv* env = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_HasClipboardText");
...
int Android_JNI_GetPowerInfo(int* plugged, int* charged, int* battery, int* seconds, int* percent)
{
    ...
    /* context = SDLActivity.getContext(); */
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_GetPowerInfo");
...
int Android_JNI_GetTouchDeviceIds(int **ids) {
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_GetTouchDeviceIds");
...
int Android_JNI_SendMessage(int command, int param)
{
    JNIEnv *env = Android_JNI_GetEnv();
    jboolean success;
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_SendMessage");
...
{
    JNIEnv *env = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_ShowTextInput");
...
SDL_bool Android_JNI_IsScreenKeyboardShown()
{
    JNIEnv *mEnv = Android_JNI_GetEnv();
    jboolean is_shown = 0;
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_IsScreenKeyboardShown");
...
int Android_JNI_ShowMessageBox(const SDL_MessageBoxData *messageboxdata, int *buttonid)
{
    ...
    /* context = SDLActivity.getContext(); */
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_ShowMessageBox");
    context = (*env)->CallStaticObjectMethod(env, mActivityClass, midGetContext);
...
void *SDL_AndroidGetActivity(void)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_AndroidGetActivity");
...
{
    JNIEnv *env = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_IsAndroidTablet");
...
{
    JNIEnv *env = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_IsAndroidTV");
...
{
    JNIEnv *env = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_IsChromebook");
...
{
    JNIEnv *env = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_IsDeXMode");
...
const char * SDL_AndroidGetInternalStoragePath(void)
{
    ...
    if (!s_AndroidInternalFilesPath) {
        ...
        /* context = SDLActivity.getContext(); */
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_AndroidGetInternalStoragePath");
        context = (*env)->CallStaticObjectMethod(env, mActivityClass, midGetContext);
        if (!context) {
...
int SDL_AndroidGetExternalStorageState(void)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_AndroidGetExternalStorageState");
...
const char * SDL_AndroidGetExternalStoragePath(void)
{
    ...
    if (!s_AndroidExternalFilesPath) {
        ...
        /* context = SDLActivity.getContext(); */
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "SDL_AndroidGetExternalStoragePath");
        context = (*env)->CallStaticObjectMethod(env, mActivityClass, midGetContext);
...
void Android_JNI_GetManifestEnvironmentVariables(void)
{
    ...
    if (!bHasEnvironmentVariables) {
        JNIEnv *env = Android_JNI_GetEnv();
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_GetManifestEnvironmentVariables");
...
{
    JNIEnv *mEnv = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_SetCustomCursor");
...
{
    JNIEnv *mEnv = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_SetSystemCursor");
...
{
    JNIEnv *mEnv = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_SupportsRelativeMouse");
...
{
    JNIEnv *mEnv = Android_JNI_GetEnv();
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "Android_JNI_SetRelativeMouseEnabled");
